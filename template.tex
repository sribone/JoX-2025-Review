...
the ligand and the catalytic residues directly involved in the hydrolysis reaction are modeled using quantum mechanics (QM), while the remaining 
...
cocaine by CES1 using hybrid QM/MM simulation alongside the experimental determination of the corresponding kinetic parameters (K\textsubscript{M}
...
linear combination of four covalent bond distances: two forming and two
